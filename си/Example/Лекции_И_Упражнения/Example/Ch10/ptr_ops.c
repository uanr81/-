...
int main(void)
{
    ...
    ptr2 = &urn[2];     // тоже самое разыменование указателя и получение адреса указателя
    printf("значение указателя   ,  разыменованный указатель, адрес указателя:\n");
    printf("ptr1 = %p,ptr2 = %p, *ptr2 = %d, *ptr1 =%d,             &ptr1 = %p\n",
           ptr1, ptr2, *ptr2, *ptr1, &ptr1);
    // сложение указателей
    ptr3 = ptr1 + 4;
    ...
    printf("\nвычитание однго указателя из другого:\n");
